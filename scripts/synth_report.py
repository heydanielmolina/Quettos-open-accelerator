...
Arrives with the synthesis flow (docs/ROADMAP.md); until then it exits 1.
...
def main() -> int:
    sys.stderr.write("synth_report.py: arrives with the synthesis flow (see docs/ROADMAP.md)\n")
    return 1
