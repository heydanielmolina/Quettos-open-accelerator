...
| [PERFORMANCE.md](PERFORMANCE.md) | The Verilator speed probe and the demo-configuration decision it settled; the harness, and the measured `make perf` and bring-up tables |
