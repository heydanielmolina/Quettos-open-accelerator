...
| [NUMERICS.md](NUMERICS.md) | Integer numerics spec: sfloat, requant, VQUANT, RMSNorm, RoPE, softmax, SiLU, LUTs; per-class formats with the calibration maxima and gate results for both models |
